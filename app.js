...
const DICT = [
  ...
  { m: "真的太", g: ["诚", "端的是"] },
  { m: "太厉害了", g: ["了得非常", "神乎其技"] },
  { m: "这个瓜也太大了", g: ["此事甚有可观", "此中大有文章"] },
  { m: "蹲一个后续", g: ["坐候下文", "静候其后续"] },
  { m: "说好", g: ["约好"] },
  { m: "奶茶", g: ["乳茶", "酪饮"] },
  { m: "姐妹们", g: ["诸位姊妹", "列位姊妹"] },
  { m: "带带我", g: ["提携一二", "携吾一程"] },
  { m: "异地恋", g: ["两地相望之恋", "分隔两地之恋"] },
  { m: "闹别扭", g: ["生嫌隙", "怄气"] },
  { m: "睡不着", g: ["辗转难眠", "竟不能寐"] },
  { m: "激动", g: ["心潮难平", "雀跃不已"] },
  { m: "终于", g: ["终得"] },
...
/* 程度词润色：去掉叠床架屋（「诚然极甚美」→「诚甚美」） */
function polishFull(text) {
  return text
    .replace(/(甚|极)(甚|极)/g, "甚")
    .replace(/(诚然|信然)(太|何其|甚|极)/g, "诚");
}
